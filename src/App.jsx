...
function App() {
    ...
    // Function to update cart (Passed Down)
    ...
    return (
        <div>
            <div className="head">
                ...
                <button class="btn btn-dark h-50 m-3"><b>📝 Login/Sign up</b></button>
                
                <button class="btn btn-dark h-50 m-3"><b>Go to 🛒 {totalItems}</b></button>  
            </div>
           ...
           <p className='col-3'><h6> contact_us</h6> mail : myhotel11@gmail.com <br />Ph.No : 9876543210 <br />FB : MyHotel_fb.com <br />Instagram : MyHotel_@tasty</p>
           <p className='col-3'><h6> Partner_Apps</h6> @Swiggy <br />@Zomato <br />@Eat_sure <br /></p>
           <p className='col-3'><h6> Office_Address</h6>H.NO : 2-22-11/34 <br />chilkanagar,uppal <br />hyderababd<br />500039 <br />Telangana</p>
